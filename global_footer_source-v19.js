...
function setReleaseToProductionState(available) {
    if (available) {
        setChannelVisible(kReleaseToProductionAttribute, kInactiveState);
        setChannelHidden(kReleaseToProductionAttribute, kActiveState);
        setChannelHidden(kReleaseToProductionAttribute, kLockedState);
    } else {
        setChannelVisible(kReleaseToProductionAttribute, kLockedState);
        setChannelHidden(kReleaseToProductionAttribute, kActiveState);
        setChannelHidden(kReleaseToProductionAttribute, kInactiveState);
    }
}
